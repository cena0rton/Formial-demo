    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="bg-[#F2F0E0] rounded-[13px] p-6 flex flex-col items-start gap-4 shadow-lg">
              <div className="flex items-center gap-3">
                <div className="rounded-full border-2 border-[#1E3F2B] bg-transparent p-3 flex items-center justify-center w-12 h-12">
                  {stepIcons[0]}
                </div>
                <span className="text-gray-700 font-medium text-sm md:text-base">{steps[0].label}</span>
              </div>
            ...
            <motion.svg
              ...
              className="absolute right-[85%] translate-x-1/2 md:top-[100%] mt-2 w-[20%] md:w-[25%] h-auto z-10 stroke-1"
              viewBox="0 0 47 45"
              fill="none"
          ...
          >
            <div className="bg-[#F2F0E0] rounded-[13px] p-6 flex flex-col items-start gap-4 shadow-lg">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium text-sm md:text-base">{steps[1].label}</span>
              </div>
            ...
            <motion.svg
              ...
              transition={{ delay: 1.8, duration: 0.8, ease: "easeOut" }}
              className="absolute right-[15%] mt-2 translate-x-1/2 md:right-[20%] md:top-[100%] w-[25%] md:w-[25%] h-auto z-10"
              viewBox="0 0 47 45"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <div className="bg-[#F2F0E0] rounded-[13px] p-6 flex flex-col items-start gap-4 shadow-lg">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium text-sm md:text-base">{steps[2].label}</span>
              </div>
