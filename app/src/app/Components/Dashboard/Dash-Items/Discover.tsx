        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              {/* Main container */}
              <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl border border-[#644B34] border-dashed shadow-[0_1px_3px_rgba(0,0,0,0.04),0_8px_24px_rgba(0,0,0,0.04)] overflow-hidden">
                ...
                <div className="px-8 md:px-12 py-16 md:py-8">
                  <div className="max-w-4xl mx-auto">
                    {/* Premium Header */}
                    <div className="text-left mb-16 space-y-5">
                      <h2 className="text-2xl md:text-3xl font-medium text-[#644B34] tracking-[-0.02em] leading-tight">
                        Let&apos;s stay connected
                      </h2>
                      <p className="text-base md:text-[16px] text-[#6B6B6B] max-w-2xl mx-auto leading-relaxed font-light">
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-4 gap-3 mb-0 -mt-6">
                      {/* WhatsApp */}
                      <motion.a
                        ...
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.98 }}
                        className="group relative flex flex-col items-center justify-center gap-3 p-8 rounded-2xl  border border-[#F0EFEB] transition-all duration-300 hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]"
